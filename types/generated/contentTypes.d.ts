...
export interface ApiSkillsImageSkillsImage extends Schema.SingleType {
  collectionName: 'skills_images';
  info: {
    singularName: 'skills-image';
    pluralName: 'skills-images';
    displayName: 'SkillsImage';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::skills-image.skills-image': ApiSkillsImageSkillsImage;
